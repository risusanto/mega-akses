                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                          ...
                                          <?php if ($row->kd_teknisi == $profile->kd_teknisi):?>
                                              <tr>
                ...
                <div class="modal fade" id="atur" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <?=form_open('teknisi/jadwal-maintenance')?>
              ...
              <script type="text/javascript">
                        ...
                        function atur_jadwal(id) {
                            $.ajax({
                                url: '<?= base_url('teknisi/jadwal-maintenance') ?>',
                                type: 'POST',
                                data: {
                                    id: id,
                                    get: true
                      ...
                      function selesai(id) {
                          ...
                          if (isConfirm) {
                              $.ajax({
                                  ...
                                  success: function() {
                                      window.location = '<?= base_url('teknisi/jadwal-maintenance') ?>';
                                  }
                              });
                          }
                          });
